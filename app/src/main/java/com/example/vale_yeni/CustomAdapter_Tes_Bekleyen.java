...
public class CustomAdapter_Tes_Bekleyen extends ArrayAdapter<Message> {

    private FirebaseUser firebaseUser;

    public CustomAdapter_Tes_Bekleyen(Context context, ArrayList<Message> chatList, FirebaseUser firebaseUser) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Message message = getItem(position);
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.teslimat_bek_arac_item, parent, false);
